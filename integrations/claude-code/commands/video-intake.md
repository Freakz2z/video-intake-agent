---
description: Name, describe, group, and safely archive local recordings.
argument-hint: <video-path-or-directory>
allowed-tools: Bash, Read
---

Use Video Intake Agent for `$ARGUMENTS`. Start with exactly one preparation command:

```bash
video-intake "$ARGUMENTS"
```
